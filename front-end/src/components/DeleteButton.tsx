...
const DeleteButton: React.FC<DeleteButtonProps> = ({ id, openInputDelete, setOpenInputDelete}) => {
    return (
        <button
            ...
            className="cursor-pointer text-red-600 text-sm bg-white hover:bg-red-100 border border-slate-200 rounded-r-lg font-medium px-4 py-2 inline-flex space-x-1 items-center">
            <span>
